...
export default function PowerPointToPdfPage() {
  ...
  const onDrop = useCallback((acceptedFiles: File[]) => {
    ...
    setFile(pptFile);
    setPreview(URL.createObjectURL(pptFile));
  }, []);
  ...
  const convertToPdf = async () => {
    ...
    try {
      ...
      const response = await fetch(`${apiBaseUrl}/api/pdf/from/powerpoint/convert`, {
        method: 'POST',
        body: formData,
      });
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-8 text-center">Convert PowerPoint to PDF</h1>
        <div
          {...getRootProps()}
          ...
          <div className="space-y-4">
            ...
            <p className="text-lg">
              {isDragActive
                ...
                : 'Drag & drop PowerPoint file here, or click to select'}
            </p>
